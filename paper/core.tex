...
\label{sec:discussion_take_away}
    ...
    \label{subsec:leveraging-our-analysis-to-obtain-convergence-bounds-on-other-classes}
        ...
        We then propose Algorithm~\ref{alg:hb_general}, which consists in applying \Cref{alg:ogm} (with the update written as in \Cref{alg:hb_ogm}) to the $\QG^+$ convex function $h^{-1} \circ (f - f_\star)$.
